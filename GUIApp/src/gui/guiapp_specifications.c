...
GX_PROMPT_PROPERTIES window2_hello_text_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window2_hello_text_define =
{
    "hello_text",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_HELLO,                                /* widget id                      */
    ...
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_hello_text), /* control block      */
    (void *) &window2_hello_text_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window2_hello_text_define,              /* child widget                   */
    0,                                       /* control block                  */
