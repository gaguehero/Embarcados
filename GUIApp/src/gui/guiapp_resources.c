...
/*  Date (dd.mm.yyyy): 11. 4.2021   Time (hh:mm): 20:29                        */
/*******************************************************************************/
...
GX_CONST GX_UBYTE display_1_WINDOW1_English[] = "Window 1";
GX_CONST GX_UBYTE display_1_WINDOW2_English[] = "Window 2";
GX_CONST GX_UBYTE display_1_INSTRUCT_BUTTON_English[] = "Press to go to window 2";
