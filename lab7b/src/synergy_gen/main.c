...
extern void thread_0_entry_create(void);
extern void thread_1_entry_create(void);
extern void thread_2_entry_create(void);
extern void thread_3_entry_create(void);
extern void thread_4_entry_create(void);
extern void thread_5_entry_create(void);
extern void thread_6_entry_create(void);
extern void thread_7_entry_create(void);
...
void tx_application_define(void *first_unused_memory)
{
    ...
    thread_0_entry_create ();
    thread_1_entry_create ();
    thread_2_entry_create ();
    thread_3_entry_create ();
    thread_4_entry_create ();
    thread_5_entry_create ();
    thread_6_entry_create ();
    thread_7_entry_create ();
