...
#ifndef _LAB6_SPECIFICATIONS_H_
#define _LAB6_SPECIFICATIONS_H_
...
typedef struct WINDOW2_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window2_windows2_text;
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window1_windows1_text;
