...
#ifndef _ENDURER_SPECIFICATIONS_H_
#define _ENDURER_SPECIFICATIONS_H_
...
#define ID_WINDOW1 1
#define ID_DIREITA 2
#define ID_ESQUERDA 3
#define ID_CARRO 4
#define ID_INIMIGO_A 5
#define ID_HIGHSCORE 6
#define ID_RACERS_LEFT 7
#define ID_POINTS1 8
#define ID_RESET1 9
#define ID_GAME_OVER 10
#define ID_INIMIGO_B 11
#define ID_INIMIGO_C 12
...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_ICON_BUTTON window1_direita;
    GX_ICON_BUTTON window1_esquerda;
    GX_ICON window1_carro;
    GX_ICON window1_inimigoA;
    GX_NUMERIC_PROMPT window1_highscore;
    GX_NUMERIC_PROMPT window1_racers_remaining;
    GX_NUMERIC_PROMPT window1_points;
    GX_ICON_BUTTON window1_reset;
    GX_PROMPT window1_game_over;
    GX_ICON window1_inimigoB;
    GX_ICON window1_inimigoC;
