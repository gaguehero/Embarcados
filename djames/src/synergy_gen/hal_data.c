...
{ .mode = TIMER_MODE_ONE_SHOT, .period = 1, .unit = TIMER_UNIT_PERIOD_SEC, .duty_cycle = 50, .duty_cycle_unit =
          TIMER_PWM_UNIT_RAW_COUNTS,
  .channel = 8, .autostart = true, .p_callback = cb0, .p_context = &g_timer0, .p_extend = &g_timer0_extend, .irq_ipl =
          (4), };
/* Instance structure to use this module. */
